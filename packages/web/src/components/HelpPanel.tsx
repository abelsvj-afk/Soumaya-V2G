...
const CATEGORIES: {
  ...
  },
  {
    ...
    items: [
      ...
      { icon: "⧉", title: "Smart Lenses (saved, self-updating views)", body: "A lens is a saved query that renders as a live constellation. Tap the ⧉ button, build one from simple dropdowns — mood (joyful/heavy/neutral), state (active, due for recall, orphans, archived), importance, recency, a keyword — and save it. Open a lens and the galaxy shows only its stars, framed for you; it stays current as your brain grows (new matches appear, ones that no longer fit drop out). Pinned lenses sit at the top with a live count. Focus a memory first and the builder offers a one-tap 'everything linked to this' lens, so a view you made by hand becomes reusable. It's all instant and offline — no AI, no cost.", tags: ["lens", "lenses", "smart lens", "saved view", "query", "filter", "self-updating", "constellation", "dataview", "isolate", "pinned"] },
