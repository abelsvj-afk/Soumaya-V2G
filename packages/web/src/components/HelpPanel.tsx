...
const CATEGORIES: {
  ...
  },
  {
    ...
    items: [
      ...
      { icon: "🌌", title: "Views — one-tap category filters", body: "The 🌌 Views button (bottom of screen) gives you quick, PRE-BUILT filters by category — one memory kind at a time, or an overlay layer like the Money sky or Journey hubs — so a lighter phone can view fewer bodies at once. It uses the exact same isolate mechanism as a Smart Lens under the hood, just with fixed, hardcoded categories instead of ones you define. Reach for Views for a quick category glance; reach for a Lens when you want a saved, reusable, self-updating filter of your own.", tags: ["views", "category", "filter", "quick", "money sky", "journey hubs", "isolate"] },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: "📷", title: "Snap or paste to log money fast", body: "'📷 Snap a screenshot' reads a pay stub, bank text, or receipt image and drafts income/expense entries for you to confirm — nothing commits until you approve it. Pasting bank text works the same way. It's the fastest way to log a batch of transactions without typing each one.", tags: ["snap", "screenshot", "paste", "import", "ocr", "vision", "receipt", "draft"] },
