...
const CATEGORIES: {
  ...
  },
  {
    ...
    items: [
      ...
      { icon: "🎭", title: "Companion: Custom Instructions", body: "Tap 🎭 inside the chat (💬) to define custom instructions and personas — roles she can take on (coach, analyst, devil's advocate…). They live right where you talk to her, since they shape WHO you're talking to. Enable, edit, or switch them so her tone and focus match what you need right now.", tags: ["companion", "instructions", "persona", "roles", "custom", "chat"] },
